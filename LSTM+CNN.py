...
# 读取数据
data = pd.read_excel(r'F:\论文\05\01-返修1\2632只-2018-2022-划分后\交通运输_2018-2022.xlsx', header=0)
...
model = CNNLSTMModel(input_size, hidden_size, num_layers, output_size, dropout_rate).to(device)
